    ...
    public class LSTM_Patch
    {
        ...
        public static void OnAwake(Harmony harmony)
        {
            ...
            harmony.Patch(AccessTools.Method(AccessTools.TypeByName("LSTMMod.UIConfigWindow"), "CreateUI"),
                null, null, new HarmonyMethod(typeof(LSTM_Patch).GetMethod(nameof(TranslateStrings))));
        }
        ...
        public static IEnumerable<CodeInstruction> TranslateStrings(IEnumerable<CodeInstruction> instructions)
        {
            ...
            var codeMatcher = new CodeMatcher(instructions)
                ...
                .Repeat(matcher => matcher
                        .Advance(1)
                        .Insert(new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(StringTranslate), nameof(StringTranslate.Translate))))
                );
        ...
        private static void RegisterStrings()
        {
            ...
            StringManager.RegisterString("Main Hotkey", "主要热键");
            StringManager.RegisterString("Show Material Picker", "显示原料选择器");
            StringManager.RegisterString("Indicates Warper Sign", "以*标记有翘曲器的塔");
            StringManager.RegisterString("Close Panel With E Key", "使用E键关闭面板");
            StringManager.RegisterString("Act As Standard Panel", "作为标准面板");
            ...
            StringManager.RegisterString("Enable Traffic Log (needs restart game)", "启用交通日志（需要重新启动游戏）");
            ...
            StringManager.RegisterString("Consider Opposite Range", "考虑对向塔的距离限制");
